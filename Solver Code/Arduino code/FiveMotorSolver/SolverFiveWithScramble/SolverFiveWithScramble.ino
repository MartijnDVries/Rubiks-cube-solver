...
rw--g-g---y-b-r-w-br----b-w---bw-o--o--g--w-og---g--w---g-r--w-o----yr---b--yr----bo--o-by-y---o--w--r-y-g-o---y-b--gr-y

#include <Stepper.h>

#define stepsPerRotation 1600

Stepper stepperBoven = AccelStepper(stepsPerRotation, 3,4);
Stepper stepperOnder = AccelStepper(stepsPerRotation, 5,6);
Stepper stepperLinks = AccelStepper(stepsPerRotation, 7,8);
Stepper stepperRechts = AccelStepper(stepsPerRotation, 9,10);
Stepper stepperAchter = AccelStepper(stepsPerRotation, 12,13);
...
char cubeArray[20][6] = { {'g','o','-','-','y','-'},
  ...
  char solved_str[] = "go--y-g---y-g-r-y-go----g-r---go-w--g--w--g-rw---o--y---r-y--o-w----rw---o--yb----yb--r-yb-o---b--r--b-o-w-b---w-b--rw-b";
...
void setup() {
  ...
  stepperBoven.setSpeed(120);
  stepperOnder.setSpeed(120);
  stepperLinks.setSpeed(120);
  stepperAchter.setSpeed(120);
  stepperRechts.setSpeed(120);
  Serial.begin(115200);
...
void loop() {
  ...
  if (input_string == 1){
    ...
    Serial.println(cubeArray[0]);
    if (TestSolve(test_str, solved_str)){
      Serial.println("Succesful solve");
    }
...
bool TestSolve(char testArr[], char solvedArr[]){
  int k = 0;
  for (int i = 0; i < 20; i++){
    for (int j = 0; j < 6; j++){
      testArr[k] = cubeArray[i][j];
      k++;
    }
  }

  for (int i = 0; i < 120; i++){
    if (testArr[i] == solvedArr[i]){
      //Serial.println(testArr[i], solvedArr[i]);
      continue;
    }
    else{
      return false;
...
void WhiteCorners(){
  ...
  if (cornerArray[0] == 1 && cornerArray[1] == 1 && cornerArray[2] == 1 && cornerArray[3] == 1){
    solveArray[1] = 1;
    //Serial.println("White corners solved");
    return;
  }
  //Serial.println("Solving white corners");
  // Top left corner
  if (cubeArray[5][3] == 'w'){
    if (cubeArray[5][0] == 'g'){
      cornerArray[0] = 1;
...
void MiddleLayer(){
  if (middleArray[0] == 1 && middleArray[1] == 1 && middleArray[2] == 1 && middleArray[3] == 1){
    solveArray[2] = 1;
    //Serial.println("Middle layer solved");
    return;
  }
...
void YellowCross(){
  ...
  // Line orange and red are in the right spot
    ...
    //Serial.println("line horizontal");
    FrontRight(cubeArray);
    LeftRight(cubeArray);
    BottomRight(cubeArray);
    LeftLeft(cubeArray);
...
void UpperEdges(){
  ...
  else if (cubeArray[1][0] != 'g'){
    upperArray[0] = 0;
  }
  if (cubeArray[8][1] == 'o'){
    upperArray[1] = 1;
  }
  else if (cubeArray[8][1] != 'o') {
    upperArray[1] = 0;
  }
  ...
  else if (cubeArray[13][5] != 'b'){
    upperArray[3] = 0;
  }
  //Serial.println("Upper edge positions");
  for (int i = 0; i < 4; i++){
    //Serial.print(upperArray[i]);
  }
  //Serial.println();
...
void UpperCorners(){
  ...
  else if  (cubeArray[0][4] =='g' && cubeArray[0][1] == 'y' && cubeArray[0][0] == 'o'){
    upperCorner[0] = 1;
  }
  else if (cubeArray[0][4] == 'o' && cubeArray[0][1] == 'g' && cubeArray[0][0] == 'y'){
    upperCorner[0] = 1;
  }
  else {
    upperCorner[0] = 0;
  ...
  else if (cubeArray[2][4] == 'r' && cubeArray[2][0] == 'y' && cubeArray[2][2] == 'g'){
    upperCorner[1] = 1;
  }
  else if (cubeArray[2][4] == 'y'  && cubeArray[2][0] == 'g' && cubeArray[2][2] == 'r'){
    upperCorner[1] = 1;
  }
  else {
    upperCorner[1] = 0;
  ...
  else if (cubeArray[12][4] ==  'b' && cubeArray[12][1] == 'y' && cubeArray[12][5] == 'o'){
    upperCorner[2] = 1;
  }
  else if (cubeArray[12][4] == 'o' && cubeArray[12][1] == 'b' && cubeArray[12][5] == 'y'){
    upperCorner[2] = 1;
  }
  else {
    upperCorner[2] = 0;
  ...
  else if (cubeArray[14][4] == 'b' && cubeArray[14][5] == 'r' && cubeArray[14][2] == 'y'){
    upperCorner[3] = 1;
  }
  else if  (cubeArray[14][4] == 'y' && cubeArray[14][5] == 'b' && cubeArray[14][2] == 'r'){
    upperCorner[3] = 1;
  }
  else {
    upperCorner[3] = 0;
  ...
  if (upperCorner[0] == 1 && upperCorner[1] == 1 && upperCorner[2] == 1 && upperCorner[3] == 1){
    solveArray[5] = 1;
    //Serial.println("upper corners (1) solved. Corner position");
    return;
  }
...
void UpperCorners2(){
  ...
  if (upperCorner2[0] == 1 && upperCorner2[1] == 1 && upperCorner2[2] == 1 && upperCorner2[3] == 1){
    solveArray[6] = 1;
    //Serial.println("Upper corner orientation solved");
    return;
  }
  else {
    if (upperCorner2[0] == 1){
